...
Elm.Planner.Component = Elm.Planner.Component || {};
Elm.Planner.Component.Event = Elm.Planner.Component.Event || {};
Elm.Planner.Component.Event.make = function (_elm) {
   "use strict";
   _elm.Planner = _elm.Planner || {};
   _elm.Planner.Component = _elm.Planner.Component || {};
   _elm.Planner.Component.Event = _elm.Planner.Component.Event || {};
   if (_elm.Planner.Component.Event.values)
   return _elm.Planner.Component.Event.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Planner.Component.Event",
   $Basics = Elm.Basics.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Planner$Component$Text = Elm.Planner.Component.Text.make(_elm),
   $Planner$Event = Elm.Planner.Event.make(_elm),
   $Planner$UI$Context = Elm.Planner.UI.Context.make(_elm),
   $Planner$UI$Dialog = Elm.Planner.UI.Dialog.make(_elm),
   $Planner$UI$DialogBuilder = Elm.Planner.UI.DialogBuilder.make(_elm);
   var showHelpEvent = _U.replace([["action"
                                   ,$Planner$Event.Dialog($Planner$UI$Dialog.Show($Planner$UI$DialogBuilder.createDialog($Planner$UI$DialogBuilder.keyboardShortcutDialogModel)))]
                                  ,["setContext"
                                   ,$Maybe.Just($Planner$UI$Context.Dialog)]],
   $Planner$Event.emptyEvent);
   var loadProjectEvent = function (event) {
      return _U.replace([["action"
                         ,$Planner$Event.Dialog($Planner$UI$Dialog.Show(A3($Planner$UI$DialogBuilder.confirm,
                         $Planner$Component$Text.confirmLoadProject,
                         $Maybe.Just(_U.replace([["setContext"
                                                 ,$Maybe.Just($Planner$UI$Context.Default)]],
                         event)),
                         $Maybe.Nothing)))]
                        ,["setContext"
                         ,$Maybe.Just($Planner$UI$Context.Dialog)]],
   ...
   var deleteNodeEvent = _U.replace([["action"
                                     ,$Planner$Event.Dialog($Planner$UI$Dialog.Show(A3($Planner$UI$DialogBuilder.confirm,
                                     $Planner$Component$Text.confirmDeleteNode,
                                     $Maybe.Just(_U.replace([["action"
                                                             ,$Planner$Event.DeleteItem]
                                                            ,["setContext"
                                                             ,$Maybe.Just($Planner$UI$Context.Default)]],
                                     $Planner$Event.emptyEvent)),
                                     $Maybe.Nothing)))]
                                    ,["setContext"
                                     ,$Maybe.Just($Planner$UI$Context.Dialog)]],
   $Planner$Event.emptyEvent);
   var newProjectEvent = _U.replace([["action"
                                     ,$Planner$Event.Dialog($Planner$UI$Dialog.Show(A3($Planner$UI$DialogBuilder.confirm,
                                     $Planner$Component$Text.confirmNewProject,
                                     $Maybe.Just(_U.replace([["action"
                                                             ,$Planner$Event.NewProject]
                                                            ,["setContext"
                                                             ,$Maybe.Just($Planner$UI$Context.Default)]],
                                     $Planner$Event.emptyEvent)),
                                     $Maybe.Nothing)))]
                                    ,["setContext"
                                     ,$Maybe.Just($Planner$UI$Context.Dialog)]],
   $Planner$Event.emptyEvent);
   _elm.Planner.Component.Event.values = {_op: _op
                                         ,newProjectEvent: newProjectEvent
                                         ,deleteNodeEvent: deleteNodeEvent
...
Elm.Planner = Elm.Planner || {};
Elm.Planner.Component = Elm.Planner.Component || {};
Elm.Planner.Component.Text = Elm.Planner.Component.Text || {};
Elm.Planner.Component.Text.make = function (_elm) {
   "use strict";
   _elm.Planner = _elm.Planner || {};
   _elm.Planner.Component = _elm.Planner.Component || {};
   _elm.Planner.Component.Text = _elm.Planner.Component.Text || {};
   if (_elm.Planner.Component.Text.values)
   return _elm.Planner.Component.Text.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Planner.Component.Text",
   $Basics = Elm.Basics.make(_elm);
   var footerText = " Created by <a href=\"http://robertjwhitaker.com\" target=\"_blank\">Robert J. Whitaker</a>\n\n*This project was programmed in <a href=\"http://elm-lang.org\" target=\"_blank\">Elm</a>. Check out the <a href=\"https://github.com/robwhitaker/Elm-Tree-Planner\" target=\"_blank\">source</a>.*\n";
   var emptyTextAreaPlaceholder = "...";
   var untitledProjectPlaceholderTitle = "Untitled Project";
   var untitledSaveTitle = "untitled";
   var expandAllButtonAlt = "Expand All";
   var collapseAllButtonAlt = "Collapse All";
   var scToAlt = function (_v0) {
      return function () {
         switch (_v0.ctor)
         {case "_Tuple2":
            return A2($Basics._op["++"],
              ...
              ")")));}
         _U.badCase($moduleName,
         "on line 51, column 31 to 65");
      }();
   };
   var showHelpShortcut = {ctor: "_Tuple2"
                          ,_0: "Show Keyboard Shortcuts"
                          ,_1: "h"};
   var showHelpButtonAlt = scToAlt(showHelpShortcut);
   var toggleFocusShortcut = {ctor: "_Tuple2"
                             ,_0: "Change Focus"
                             ,_1: "Tab"};
   var editTitleShortcut = {ctor: "_Tuple2"
                           ,_0: "Focus Title"
                           ,_1: "Esc"};
   var moveSelectionDownShortcut = {ctor: "_Tuple2"
                                   ,_0: "Move Selection Down"
                                   ,_1: "DownArrow"};
   var moveSelectionUpShortcut = {ctor: "_Tuple2"
                                 ,_0: "Move Selection Up"
                                 ,_1: "UpArrow"};
   var moveNodeRightShortcut = {ctor: "_Tuple2"
                               ,_0: "Move Node Right"
                               ,_1: "Ctrl+RightArrow"};
   var moveNodeRightButtonAlt = scToAlt(moveNodeRightShortcut);
   var moveNodeDownShortcut = {ctor: "_Tuple2"
                              ,_0: "Move Node Down"
                              ,_1: "Ctrl+DownArrow"};
   var moveNodeDownButtonAlt = scToAlt(moveNodeDownShortcut);
   var moveNodeUpShortcut = {ctor: "_Tuple2"
                            ,_0: "Move Node Up"
                            ,_1: "Ctrl+UpArrow"};
   var moveNodeUpButtonAlt = scToAlt(moveNodeUpShortcut);
   var moveNodeLeftShortcut = {ctor: "_Tuple2"
                              ,_0: "Move Node Left"
                              ,_1: "Ctrl+LeftArrow"};
   var moveNodeLeftButtonAlt = scToAlt(moveNodeLeftShortcut);
   var deleteNodeShortcut = {ctor: "_Tuple2"
                            ,_0: "Delete Node"
                            ,_1: "Del"};
   var deleteNodeButtonAlt = scToAlt(deleteNodeShortcut);
   var toggleExpandedShortcut = {ctor: "_Tuple2"
                                ,_0: "Toggle Expanded"
                                ,_1: "Space"};
   var toggleExpandedButtonAlt = scToAlt(toggleExpandedShortcut);
   var renameNodeShortcut = {ctor: "_Tuple2"
                            ,_0: "Rename Node"
                            ,_1: "Return"};
   var renameNodeButtonAlt = scToAlt(renameNodeShortcut);
   var newNodeShortcut = {ctor: "_Tuple2"
                         ,_0: "New Node"
                         ,_1: "Ctrl+Return"};
   var newNodeButtonAlt = scToAlt(newNodeShortcut);
   var loadProjectShortcut = {ctor: "_Tuple2"
                             ,_0: "Load Project"
                             ,_1: "Ctrl+O"};
   var loadProjectButtonAlt = scToAlt(loadProjectShortcut);
   var saveProjectShortcut = {ctor: "_Tuple2"
                             ,_0: "Save Project"
                             ,_1: "Ctrl+S"};
   var saveProjectButtonAlt = scToAlt(saveProjectShortcut);
   var newProjectShortcut = {ctor: "_Tuple2"
                            ,_0: "New Project"
                            ,_1: "Ctrl+/"};
   var newProjectButtonAlt = scToAlt(newProjectShortcut);
   var newItemTitle = "new";
   var confirmLoadProject = "Are you sure you want to load a new project? Any unsaved progress will be lost.";
   var confirmDeleteNode = "Are you sure you want to delete this item and all sub-items?";
   var confirmNewProject = "Are you sure you want to create a new project? Any unsaved progress will be lost.";
   _elm.Planner.Component.Text.values = {_op: _op
                                        ,confirmNewProject: confirmNewProject
                                        ,confirmDeleteNode: confirmDeleteNode
                                        ,confirmLoadProject: confirmLoadProject
                                        ,newItemTitle: newItemTitle
                                        ,newProjectShortcut: newProjectShortcut
                                        ,saveProjectShortcut: saveProjectShortcut
                                        ,loadProjectShortcut: loadProjectShortcut
                                        ,newNodeShortcut: newNodeShortcut
                                        ,renameNodeShortcut: renameNodeShortcut
                                        ,toggleExpandedShortcut: toggleExpandedShortcut
                                        ,deleteNodeShortcut: deleteNodeShortcut
                                        ,moveNodeLeftShortcut: moveNodeLeftShortcut
                                        ,moveNodeUpShortcut: moveNodeUpShortcut
                                        ,moveNodeDownShortcut: moveNodeDownShortcut
                                        ,moveNodeRightShortcut: moveNodeRightShortcut
                                        ,moveSelectionUpShortcut: moveSelectionUpShortcut
                                        ,moveSelectionDownShortcut: moveSelectionDownShortcut
                                        ,editTitleShortcut: editTitleShortcut
                                        ,toggleFocusShortcut: toggleFocusShortcut
                                        ,showHelpShortcut: showHelpShortcut
                                        ,scToAlt: scToAlt
                                        ,newProjectButtonAlt: newProjectButtonAlt
                                        ,saveProjectButtonAlt: saveProjectButtonAlt
                                        ,loadProjectButtonAlt: loadProjectButtonAlt
                                        ,newNodeButtonAlt: newNodeButtonAlt
                                        ,renameNodeButtonAlt: renameNodeButtonAlt
                                        ,toggleExpandedButtonAlt: toggleExpandedButtonAlt
                                        ,deleteNodeButtonAlt: deleteNodeButtonAlt
                                        ,moveNodeLeftButtonAlt: moveNodeLeftButtonAlt
                                        ,moveNodeUpButtonAlt: moveNodeUpButtonAlt
                                        ,moveNodeDownButtonAlt: moveNodeDownButtonAlt
                                        ,moveNodeRightButtonAlt: moveNodeRightButtonAlt
                                        ,collapseAllButtonAlt: collapseAllButtonAlt
                                        ,expandAllButtonAlt: expandAllButtonAlt
                                        ,showHelpButtonAlt: showHelpButtonAlt
                                        ,untitledSaveTitle: untitledSaveTitle
                                        ,untitledProjectPlaceholderTitle: untitledProjectPlaceholderTitle
                                        ,emptyTextAreaPlaceholder: emptyTextAreaPlaceholder
                                        ,footerText: footerText};
   return _elm.Planner.Component.Text.values;
};
Elm.Planner = Elm.Planner || {};
Elm.Planner.Data = Elm.Planner.Data || {};
Elm.Planner.Data.Tree = Elm.Planner.Data.Tree || {};
Elm.Planner.Data.Tree.make = function (_elm) {
   "use strict";
   _elm.Planner = _elm.Planner || {};
   _elm.Planner.Data = _elm.Planner.Data || {};
   _elm.Planner.Data.Tree = _elm.Planner.Data.Tree || {};
   if (_elm.Planner.Data.Tree.values)
   return _elm.Planner.Data.Tree.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Planner.Data.Tree",
   $Basics = Elm.Basics.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   ...
   var nodeById = F2(function (id,
   tree) {
      return $List.head($List.filter(function (_v12) {
         return function () {
            switch (_v12.ctor)
            {case "Node": return _U.eq(id,
                 _v12._2);}
            _U.badCase($moduleName,
            "on line 81, column 65 to 74");
         }();
      })(flatten(tree)));
   });
   var nodeByIdWithDefault = F3(function ($default,
   id,
   tree) {
      return $Maybe.withDefault($default)(A2(nodeById,
      id,
      tree));
   });
   var nextId = function (root) {
      return 1 + A3(foldN,
      F2(function (_v17,acc) {
         return function () {
            switch (_v17.ctor)
            {case "Node":
               return _U.cmp(_v17._2,
                 acc) > 0 ? _v17._2 : acc;}
            _U.badCase($moduleName,
            "on line 58, column 48 to 76");
         }();
      }),
      -1,
      root);
   ...
   var size = function (tree) {
      return A3(fold,
      F2(function (node,acc) {
         return acc + 1;
      }),
      0,
      tree);
   };
   var id = function (_v26) {
      return function () {
         switch (_v26.ctor)
         {case "Node": return _v26._2;}
         _U.badCase($moduleName,
         "on line 26, column 20 to 22");
      }();
   };
   var value = function (_v31) {
      return function () {
         switch (_v31.ctor)
         {case "Node": return _v31._0;}
         _U.badCase($moduleName,
         "on line 23, column 26 to 31");
      }();
   };
   var children = function (_v36) {
      return function () {
         switch (_v36.ctor)
         {case "Node": return _v36._1;}
         _U.badCase($moduleName,
         "on line 20, column 32 to 40");
      }();
   };
   var parent = F2(function (child,
   root) {
      return _U.eq(children(root),
      _L.fromArray([])) ? $Maybe.Nothing : A2($List.member,
      child,
      children(root)) ? $Maybe.Just(root) : $List.head(A2($List.filterMap,
      parent(child),
      children(root)));
   });
   var Lower = {ctor: "Lower"};
   var Lift = {ctor: "Lift"};
   var ShiftDown = {ctor: "ShiftDown"};
   var ShiftUp = {ctor: "ShiftUp"};
   var Down = {ctor: "Down"};
   var Up = {ctor: "Up"};
   ...
   var dummyNode = function (value) {
      return A3(Node,
      value,
      _L.fromArray([]),
      -1);
   };
   var valueM = F2(function (f,
   _v41) {
      return function () {
         switch (_v41.ctor)
         {case "Node": return A3(Node,
              f(_v41._0),
              _v41._1,
              _v41._2);}
         _U.badCase($moduleName,
         "on line 34, column 37 to 63");
      }();
   });
   var map = F2(function (f,_v46) {
      return function () {
         switch (_v46.ctor)
         {case "Node": return A3(Node,
              f(_v46._0),
              A2($List.map,map(f),_v46._1),
              _v46._2);}
         _U.badCase($moduleName,
         "on line 37, column 34 to 79");
      }();
   });
   var mapToNodeById = F3(function (f,
   id,
   _v51) {
      return function () {
         switch (_v51.ctor)
         {case "Node": return _U.eq(id,
              ...
              _v51._0,
              A2($List.map,
              A2(mapToNodeById,f,id),
              _v51._1),
              _v51._2);}
         _U.badCase($moduleName,
         "on line 41, column 5 to 111");
      }();
   });
   var mapN = F2(function (f,
   _v56) {
      return function () {
         switch (_v56.ctor)
         {case "Node": return f(A3(Node,
              _v56._0,
              A2($List.map,mapN(f),_v56._1),
              _v56._2));}
         _U.badCase($moduleName,
         "on line 44, column 35 to 80");
      }();
   });
   var addChild = F2(function (child,
   _v61) {
      return function () {
         switch (_v61.ctor)
         {case "Node": return A3(Node,
              ...
              _v61._2);}
         _U.badCase($moduleName,
         "on line 47, column 43 to 78");
      }();
   });
   var addChildTo = F3(function (parent,
   child,
   root) {
      return _U.eq(parent,
      root) ? A2(addChild,
      ...
      value(root),
      A2($List.map,
      A2(addChildTo,parent,child),
      children(root)),
      id(root));
   });
   var addChildToNodeById = F3(function (id,
   child,
   root) {
      return function () {
         var _v66 = A2(nodeById,
         id,
         root);
         switch (_v66.ctor)
         {case "Just":
            return A3(addChildTo,
              _v66._0,
              child,
              root);
   ...
   var removeNode = F2(function (node,
   root) {
      return A2($List.member,
      node,
      children(root)) ? A3(Node,
      value(root),
      A2($List.filter,
      F2(function (x,y) {
         return !_U.eq(x,y);
   ...
   var removeNodeById = F2(function (id,
   root) {
      return A2(removeNode,
      $Maybe.withDefault(dummyNode(value(root)))(A2(nodeById,
      id,
      root)),
      root);
   });
   var shiftNode = F3(function (dir,
   node,
   root) {
      return A2($List.member,
      node,
      children(root)) ? function () {
         var indexedChildren = A2($List.indexedMap,
         F2(function (v0,v1) {
            return {ctor: "_Tuple2"
                   ,_0: v0
                   ,_1: v1};
         ...
         children(root));
         var targetNode = $Maybe.withDefault({ctor: "_Tuple2"
                                             ,_0: -1
                                             ,_1: node})($List.head(A2($List.filter,
         function ($) {
         ...
         indexedChildren)));
         var offset = _U.eq(dir,
         Up) ? -1 : 1;
         var newChildren = function ($) {
            return $List.map($Basics.snd)($List.sortBy($Basics.fst)($List.map(function (node$) {
               return _U.eq(node$,
               targetNode) ? {ctor: "_Tuple2"
                             ,_0: $Basics.fst(node$) + offset
                             ,_1: $Basics.snd(node$)} : node$;
            })($List.map(function (_v68) {
               return function () {
                  switch (_v68.ctor)
                  {case "_Tuple2":
                     return _U.eq(_v68._0,
                       $Basics.fst(targetNode) + offset) ? {ctor: "_Tuple2"
                                                           ,_0: _v68._0 - offset
                                                           ,_1: _v68._1} : {ctor: "_Tuple2"
                                                                           ,_0: _v68._0
                                                                           ,_1: _v68._1};}
                  _U.badCase($moduleName,
                  "on line 116, column 53 to 135");
               }();
            })($))));
         }(indexedChildren);
         return A3(Node,
      ...
      value(root),
      A2($List.map,
      A2(shiftNode,dir,node),
      children(root)),
      id(root));
   });
   var liftNode = F2(function (node,
   root) {
      return function () {
         var grandparent = root;
         var parents = children(grandparent);
         var kids = A2($List.map,
         children,
         parents);
         var parentsAndKids = A3($List.map2,
         F2(function (v0,v1) {
            return {ctor: "_Tuple2"
                   ,_0: v0
                   ,_1: v1};
         ...
         parents,
         kids);
         var parent = $List.head($List.map($Basics.fst)(A2($List.filter,
         function ($) {
            return $List.member(node)($Basics.snd($));
         },
         parentsAndKids)));
         return function () {
            switch (parent.ctor)
            {case "Just": return A3(Node,
                 value(grandparent),
                 A2($Basics._op["++"],
                 A2($Util$List.takeWhile,
                 F2(function (x,y) {
                    return !_U.eq(x,y);
                 })(parent._0),
                 parents),
                 A2($Basics._op["++"],
                 _L.fromArray([A2(removeNode,
                              node,
                              parent._0)
                              ,node]),
                 $List.drop(1)(A2($Util$List.dropWhile,
                 F2(function (x,y) {
                    return !_U.eq(x,y);
                 })(parent._0),
                 parents)))),
                 id(grandparent));
               case "Nothing": return A3(Node,
                 value(root),
                 A2($List.map,
                 liftNode(node),
                 children(root)),
   ...
   var lowerNode = F2(function (node,
   root) {
      return A2($List.member,
      node,
      children(root)) ? function () {
         var nodePosition = $List.length(children(root)) - $List.length(A2($Util$List.dropWhile,
         F2(function (x,y) {
            return !_U.eq(x,y);
         })(node),
         children(root)));
         var elementBeforeNode = _U.eq(nodePosition,
         0) ? $Maybe.Nothing : $List.head(A2($List.drop,
         nodePosition - 1,
         children(root)));
         return function () {
            switch (elementBeforeNode.ctor)
            {case "Just": return A3(Node,
                 value(root),
                 A2($Basics._op["++"],
                 A2($Util$List.takeWhile,
                 F2(function (x,y) {
                    return !_U.eq(x,y);
                 })(elementBeforeNode._0),
                 children(root)),
                 A2($Basics._op["++"],
                 _L.fromArray([A2(addChild,
                 node,
                 elementBeforeNode._0)]),
                 $List.drop(1)(A2($Util$List.dropWhile,
                 F2(function (x,y) {
   ...
   var moveNode = F3(function (movement,
   node,
   root) {
      return function () {
         switch (movement.ctor)
         {case "Lift":
            return A2(liftNode,node,root);
            case "Lower":
            return A2(lowerNode,node,root);
            case "ShiftDown":
            return A3(shiftNode,
              Down,
              node,
   ...
   var moveNodeById = F3(function (movement,
   id,
   root) {
      return A3(moveNode,
      movement,
      $Maybe.withDefault(root)(A2(nodeById,
      id,
      root)),
      root);
   });
   ...
   var empty = Empty;
   _elm.Planner.Data.Tree.values = {_op: _op
                                   ,Empty: Empty
                                   ,Node: Node
                                   ,Up: Up
                                   ,Down: Down
                                   ...
                                   ,fold: fold
                                   ,nodeById: nodeById
                                   ,nodeByIdWithDefault: nodeByIdWithDefault
                                   ,addChildTo: addChildTo
                                   ,addChildToNodeById: addChildToNodeById
...
Elm.Planner = Elm.Planner || {};
Elm.Planner.Event = Elm.Planner.Event || {};
Elm.Planner.Event.make = function (_elm) {
   "use strict";
   _elm.Planner = _elm.Planner || {};
   _elm.Planner.Event = _elm.Planner.Event || {};
   if (_elm.Planner.Event.values)
   return _elm.Planner.Event.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Planner.Event",
   $Maybe = Elm.Maybe.make(_elm),
   $Planner$Data$Tree = Elm.Planner.Data.Tree.make(_elm),
   $Planner$UI$Context = Elm.Planner.UI.Context.make(_elm),
   $Planner$UI$Dialog = Elm.Planner.UI.Dialog.make(_elm);
   ...
   var UIEvent = function (a) {
      return {ctor: "UIEvent"
             ,_0: a};
   };
   var KeyboardEvent = function (a) {
      return {ctor: "KeyboardEvent"
             ,_0: a};
   };
   var Down = {ctor: "Down"};
   var Up = {ctor: "Up"};
   ...
   var emptyEvent = {_: {}
                    ,action: NoOp
                    ,setContext: $Maybe.Nothing};
   var ToggleExpanded = function (a) {
      return {ctor: "ToggleExpanded"
             ,_0: a};
   };
   var MoveNode = function (a) {
      return {ctor: "MoveNode"
             ,_0: a};
   };
   var DeleteItem = {ctor: "DeleteItem"};
   var RenameProject = function (a) {
      return {ctor: "RenameProject"
             ,_0: a};
   };
   var RenamingItem = function (a) {
      return {ctor: "RenamingItem"
             ,_0: a};
   };
   ...
   var RenameItem = function (a) {
      return {ctor: "RenameItem"
             ,_0: a};
   };
   var MoveSelection = function (a) {
      return {ctor: "MoveSelection"
             ,_0: a};
   };
   var SelectItem = function (a) {
      return {ctor: "SelectItem"
             ,_0: a};
   };
   var LoadProject = function (a) {
      return {ctor: "LoadProject"
             ,_0: a};
   };
   var SaveProject = {ctor: "SaveProject"};
   var UpdateItemTitle = function (a) {
      return {ctor: "UpdateItemTitle"
             ,_0: a};
   };
   var NewProject = {ctor: "NewProject"};
   var Dialog = function (a) {
      return {ctor: "Dialog"
             ,_0: a};
   };
   var SetAllExpanded = function (a) {
      return {ctor: "SetAllExpanded"
             ,_0: a};
   };
   var NewItem = {ctor: "NewItem"};
   _elm.Planner.Event.values = {_op: _op
                               ,NewItem: NewItem
...
Elm.Planner = Elm.Planner || {};
Elm.Planner.Main = Elm.Planner.Main || {};
Elm.Planner.Main.make = function (_elm) {
   "use strict";
   _elm.Planner = _elm.Planner || {};
   _elm.Planner.Main = _elm.Planner.Main || {};
   if (_elm.Planner.Main.values)
   return _elm.Planner.Main.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Planner.Main",
   $Basics = Elm.Basics.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Keyboard = Elm.Keyboard.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Planner$Component$Event = Elm.Planner.Component.Event.make(_elm),
   $Planner$Component$Text = Elm.Planner.Component.Text.make(_elm),
   $Planner$Data$Tree = Elm.Planner.Data.Tree.make(_elm),
   $Planner$Event = Elm.Planner.Event.make(_elm),
   $Planner$Model = Elm.Planner.Model.make(_elm),
   $Planner$UI$Context = Elm.Planner.UI.Context.make(_elm),
   $Planner$Update = Elm.Planner.Update.make(_elm),
   $Planner$View = Elm.Planner.View.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Set = Elm.Set.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $String = Elm.String.make(_elm),
   $Window = Elm.Window.make(_elm);
   var log = Elm.Native.Port.make(_elm).outboundSignal("log",
   function (v) {
      return v;
   },
   $Signal.constant(""));
   var fileUpload = Elm.Native.Port.make(_elm).inboundSignal("fileUpload",
   "String",
   function (v) {
   ...
   var ticker = Elm.Native.Port.make(_elm).inboundSignal("ticker",
   "Bool",
   function (v) {
      return typeof v === "boolean" ? v : _U.badPort("a boolean (true or false)",
      v);
   });
   var uiEvent = $Signal.mailbox($Planner$Event.emptyEvent);
   var load = A2($Signal._op["<~"],
   function (json) {
      return $Planner$Component$Event.loadProjectEvent(_U.replace([["action"
                                                                   ,$Planner$Event.LoadProject(json)]],
      $Planner$Event.emptyEvent));
   },
   fileUpload);
   var keyboardInput = A2($Signal._op["<~"],
   $Set.toList,
   $Signal.dropRepeats($Keyboard.keysDown));
   var inputEvent = $Signal.mergeMany(_L.fromArray([A2($Signal._op["<~"],
                                                   $Planner$Event.UIEvent,
                                                   uiEvent.signal)
                                                   ,A2($Signal._op["<~"],
                                                   $Planner$Event.KeyboardEvent,
                                                   keyboardInput)
                                                   ,A2($Signal._op["<~"],
                                                   $Planner$Event.UIEvent,
                                                   load)]));
   var initialModel = function (result) {
      return function () {
         switch (result.ctor)
         {case "Ok": return function () {
                 ...
                 return _U.replace([["ui"
                                    ,_U.replace([["context"
                                                 ,$Planner$UI$Context.Default]],
                                    ui)]],
                 result._0);
              }();}
         return $Planner$Model.emptyModel;
      }();
   }($Planner$Model.decodeState(getStorage));
   ...
   {ctor: "_Tuple2"
   ,_0: ""
   ,_1: $Maybe.Nothing})($Signal.dropRepeats(A2($Signal.map,
   function (s) {
      return function () {
         var _v2 = s.ui.context;
         switch (_v2.ctor)
         {case "MainTextArea":
            return {ctor: "_Tuple2"
                   ,_0: "#textbox"
            ...
            return {ctor: "_Tuple2"
                   ,_0: A2($Basics._op["++"],
                   "#node-",
                   $Basics.toString(s.selectedId))
                   ,_1: $Maybe.map(function ($) {
                      return function (_) {
                         return _.title;
                      }($Planner$Data$Tree.value($));
                   })(A2($Planner$Data$Tree.nodeById,
                   s.selectedId,
                   s.rootNode))};
            case "TitleInput":
            return {ctor: "_Tuple2"
                   ,_0: "#title-bar-input"
                   ,_1: $Maybe.Just(s.projectTitle)};}
         return {ctor: "_Tuple2"
                ,_0: "default"
                ,_1: $Maybe.Nothing};
      }();
   ...
   state))));
   var scroll = Elm.Native.Port.make(_elm).outboundSignal("scroll",
   function (v) {
      return v;
   },
   A2($Signal.map,
   ...
   state));
   var textBoxText = Elm.Native.Port.make(_elm).outboundSignal("textBoxText",
   function (v) {
      return v;
   },
   function () {
      var isSelection = A2($Signal.map,
      function (s) {
         return !_U.eq(s.selectedId,
         s.ui.lastSelectedId);
      },
      state);
      return $Signal.sampleOn(A2($Signal.merge,
      A3($Signal.filter,
      $Basics.identity,
      false,
      isSelection),
      ticker))(A2($Signal.map,
      function (s) {
         return $Maybe.withDefault("")($Maybe.map(function ($) {
            return function (_) {
               return _.content;
            }($Planner$Data$Tree.value($));
         })(A2($Planner$Data$Tree.nodeById,
   ...
   var save = Elm.Native.Port.make(_elm).outboundSignal("save",
   function (v) {
      return [v._0,v._1];
   },
   function () {
      var fileName = function ($) {
         return $String.join("_")($String.words($));
      };
      return $Signal.sampleOn(A2($Signal.merge,
      A3($Signal.filterMap,
      function (event) {
         return _U.eq(event.action,
         $Planner$Event.SaveProject) ? $Maybe.Just({ctor: "_Tuple0"}) : $Maybe.Nothing;
      },
      {ctor: "_Tuple0"},
      uiEvent.signal),
      A3($Signal.filterMap,
      function (keys) {
         return _U.eq(keys,
         _L.fromArray([17
                      ,83])) ? $Maybe.Just({ctor: "_Tuple0"}) : $Maybe.Nothing;
      },
      {ctor: "_Tuple0"},
      keyboardInput)))(A2($Signal.map,
      function (s) {
         ...
         _U.eq(s.projectTitle,
         "") ? $Planner$Component$Text.untitledSaveTitle : fileName(s.projectTitle),
         $Planner$Model.encodeState(s));
      },
      state));
   }());
   ...
   A2($Signal.map,
   $Planner$Model.encodeState,
   state));
   var main = A2($Signal._op["~"],
   A2($Signal._op["<~"],
   $Planner$View.render(uiEvent.address),
   state),
   $Window.dimensions);
   _elm.Planner.Main.values = {_op: _op
                              ,main: main
...
Elm.Planner = Elm.Planner || {};
Elm.Planner.Model = Elm.Planner.Model || {};
Elm.Planner.Model.make = function (_elm) {
   "use strict";
   _elm.Planner = _elm.Planner || {};
   _elm.Planner.Model = _elm.Planner.Model || {};
   if (_elm.Planner.Model.values)
   return _elm.Planner.Model.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Planner.Model",
   $Basics = Elm.Basics.make(_elm),
   $Json$Decode = Elm.Json.Decode.make(_elm),
   $Json$Encode = Elm.Json.Encode.make(_elm),
   $List = Elm.List.make(_elm),
      ...
      return function () {
         var encodeItem = function (item) {
            return $Json$Encode.object(_L.fromArray([{ctor: "_Tuple2"
                                                    ...
                                                    ,{ctor: "_Tuple2"
                                                     ,_0: "content"
                                                     ,_1: $Json$Encode.string(item.content)}
                                                    ,{ctor: "_Tuple2"
                                                     ,_0: "expanded"
                                                     ,_1: $Json$Encode.bool(item.expanded)}]));
         };
         var encodeTree = function (_v0) {
            return function () {
               switch (_v0.ctor)
               {case "Node":
                  return $Json$Encode.object(_L.fromArray([{ctor: "_Tuple2"
                                                           ,_0: "value"
                                                           ,_1: encodeItem(_v0._0)}
                                                          ,{ctor: "_Tuple2"
                                                           ,_0: "children"
         ...
         var encodeState$ = function (s) {
            return $Json$Encode.object(_L.fromArray([{ctor: "_Tuple2"
                                                     ,_0: "rootNode"
                                                     ,_1: encodeTree(s.rootNode)}
                                                    ,{ctor: "_Tuple2"
                                                     ,_0: "projectTitle"
                                                     ,_1: $Json$Encode.string(s.projectTitle)}
                                                    ,{ctor: "_Tuple2"
                                                     ,_0: "selectedId"
                                                     ,_1: $Json$Encode.$int(s.selectedId)}]));
         };
         return $Json$Encode.encode(0)(encodeState$(s));
      }();
   };
   var emptyUIState = {_: {}
                      ,context: $Planner$UI$Context.Default
                      ,dialog: $Maybe.Nothing
                      ,lastContext: $Planner$UI$Context.Default
                      ,lastSelectedId: -1};
   var newItem = {_: {}
                 ,content: ""
                 ,expanded: true
                 ,title: $Planner$Component$Text.newItemTitle};
   var emptyModel = {_: {}
                    ,projectTitle: ""
                    ,rootNode: A3($Planner$Data$Tree.newNode,
                    $Planner$Data$Tree.Empty,
                    newItem,
                    _L.fromArray([]))
                    ,selectedId: 0
                    ,ui: emptyUIState};
   ...
   var decodeState = function (s) {
      return function () {
         ...
         var itemDecoder = A4($Json$Decode.object3,
         Item,
         A2($Json$Decode._op[":="],
         "title",
         $Json$Decode.string),
         ...
         "expanded",
         $Json$Decode.bool));
         var treeDecoder = A4($Json$Decode.object3,
         $Planner$Data$Tree.Node,
         A2($Json$Decode._op[":="],
         "value",
         itemDecoder),
         A2($Json$Decode._op[":="],
         "children",
         $Json$Decode.list(lazy(function (_v5) {
            return function () {
               return treeDecoder;
            }();
         }))),
         ...
         "id",
         $Json$Decode.$int));
         var stateDecoder = A4($Json$Decode.object3,
         State(emptyUIState),
         A2($Json$Decode._op[":="],
         "rootNode",
         treeDecoder),
   ...
   _elm.Planner.Model.values = {_op: _op
                               ,State: State
                               ,UIState: UIState
                               ,Item: Item
                               ,newItem: newItem
...
Elm.Planner = Elm.Planner || {};
Elm.Planner.UI = Elm.Planner.UI || {};
Elm.Planner.UI.Context = Elm.Planner.UI.Context || {};
Elm.Planner.UI.Context.make = function (_elm) {
   "use strict";
   _elm.Planner = _elm.Planner || {};
   _elm.Planner.UI = _elm.Planner.UI || {};
   _elm.Planner.UI.Context = _elm.Planner.UI.Context || {};
   if (_elm.Planner.UI.Context.values)
   return _elm.Planner.UI.Context.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Planner.UI.Context";
   var RenamingNode = {ctor: "RenamingNode"};
   var MainTextArea = {ctor: "MainTextArea"};
   var TitleInput = {ctor: "TitleInput"};
   var Dialog = {ctor: "Dialog"};
   var TextInput = {ctor: "TextInput"};
   var Default = {ctor: "Default"};
   _elm.Planner.UI.Context.values = {_op: _op
                                    ,Default: Default
                                    ,TextInput: TextInput
                                    ,Dialog: Dialog
...
Elm.Planner = Elm.Planner || {};
Elm.Planner.UI = Elm.Planner.UI || {};
Elm.Planner.UI.Dialog = Elm.Planner.UI.Dialog || {};
Elm.Planner.UI.Dialog.make = function (_elm) {
   "use strict";
   _elm.Planner = _elm.Planner || {};
   _elm.Planner.UI = _elm.Planner.UI || {};
   _elm.Planner.UI.Dialog = _elm.Planner.UI.Dialog || {};
   if (_elm.Planner.UI.Dialog.values)
   return _elm.Planner.UI.Dialog.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Planner.UI.Dialog",
   $Basics = Elm.Basics.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Signal = Elm.Signal.make(_elm);
      ...
      return function () {
         ...
         function (dial) {
            return function () {
               switch (action.ctor)
               {case "Custom":
                  return $Maybe.Just(_U.replace([["model"
                                                 ,A2(dial.update,
                                                 action._0,
                                                 dial.model)]],
                    dial));
   ...
   var Custom = function (a) {
      return {ctor: "Custom"
             ,_0: a};
   };
   var HideWith = function (a) {
      return {ctor: "HideWith"
             ,_0: a};
   };
   var Hide = {ctor: "Hide"};
   var Show = function (a) {
   ...
   var KeyboardShortcutDialog = function (a) {
      return {ctor: "KeyboardShortcutDialog"
             ,_0: a};
   };
   var ConfirmDialog = function (a) {
      return {ctor: "ConfirmDialog"
             ,_0: a};
   };
   var Dialog = F4(function (a,
   b,
   c,
   d) {
      return {_: {}
   ...
   _elm.Planner.UI.Dialog.values = {_op: _op
                                   ,Dialog: Dialog
...
Elm.Planner = Elm.Planner || {};
Elm.Planner.UI = Elm.Planner.UI || {};
Elm.Planner.UI.DialogBuilder = Elm.Planner.UI.DialogBuilder || {};
Elm.Planner.UI.DialogBuilder.make = function (_elm) {
   "use strict";
   _elm.Planner = _elm.Planner || {};
   _elm.Planner.UI = _elm.Planner.UI || {};
   _elm.Planner.UI.DialogBuilder = _elm.Planner.UI.DialogBuilder || {};
   if (_elm.Planner.UI.DialogBuilder.values)
   return _elm.Planner.UI.DialogBuilder.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Planner.UI.DialogBuilder",
   $Basics = Elm.Basics.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Planner$UI$Context = Elm.Planner.UI.Context.make(_elm),
   $Planner$UI$Dialog = Elm.Planner.UI.Dialog.make(_elm);
   var createDialog = function (model) {
      return function () {
         switch (model.ctor)
         {case "ConfirmDialog":
            return $Maybe.Just({_: {}
                               ,keyboardInputMap: F2(function (keypresses,
                               dialModel) {
                                  return function () {
                                     var _raw = dialModel,
                                     $ = _raw.ctor === "ConfirmDialog" ? _raw : _U.badCase($moduleName,
                                     "on line 110, column 49 to 58"),
                                     m$ = $._0;
                                     var confirmAction = _U.eq(m$.selectedOption,
                                     0) ? m$.confirm : m$.cancel;
                                     return function () {
                                        switch (keypresses.ctor)
                                        {case "::":
                                           switch (keypresses._0)
                                             {case 13:
                                                switch (keypresses._1.ctor)
                                                  {case "[]":
                                                     return _U.replace([["action"
                                                                        ,$Planner$Event.Dialog($Planner$UI$Dialog.HideWith(confirmAction))]],
                                                       $Planner$Event.emptyEvent);}
                                                  break;
                                                case 27:
                                                switch (keypresses._1.ctor)
                                                  {case "[]": return m$.cancel;}
                                                  break;
                                                case 37:
                                                switch (keypresses._1.ctor)
                                                  {case "[]":
                                                     return _U.replace([["action"
                                                                        ,$Planner$Event.Dialog($Planner$UI$Dialog.Custom($Planner$UI$Dialog.ChangeSelection(0)))]],
                                                       $Planner$Event.emptyEvent);}
                                                  break;
                                                case 39:
                                                switch (keypresses._1.ctor)
                                                  {case "[]":
                                                     return _U.replace([["action"
                                                                        ,$Planner$Event.Dialog($Planner$UI$Dialog.Custom($Planner$UI$Dialog.ChangeSelection(1)))]],
                                                       $Planner$Event.emptyEvent);}
                                                  break;}
                                             break;}
                                        return $Planner$Event.emptyEvent;
                                     }();
                                  }();
                               })
                               ,model: model
                               ,update: F2(function (action,
                               dialModel) {
                                  return function () {
                                     var _raw = dialModel,
                                     $ = _raw.ctor === "ConfirmDialog" ? _raw : _U.badCase($moduleName,
                                     "on line 78, column 49 to 58"),
                                     m$ = $._0;
                                     return function () {
                                        switch (action.ctor)
                                        {case "ChangeSelection":
                                           return $Planner$UI$Dialog.ConfirmDialog(_U.replace([["selectedOption"
                                                                                               ,action._0]],
                                             m$));}
                                        return dialModel;
                                     }();
                                  ...
                                  return function () {
                                     ...
                                     {case "_Tuple2":
                                        return function () {
                                             var _raw = dialModel,
                                             $ = _raw.ctor === "ConfirmDialog" ? _raw : _U.badCase($moduleName,
                                             "on line 84, column 49 to 58"),
                                             m$ = $._0;
                                             return A2($Html.div,
                                             _L.fromArray([]),
                                             _L.fromArray([A2($Html.div,
                                                          _L.fromArray([$Html$Attributes.$class("modal-background")
                                                                       ,A2($Html$Events.onClick,
                                                                       address,
                                                                       m$.cancel)]),
                                                          _L.fromArray([]))
                                                          ,A2($Html.div,
                                                          _L.fromArray([$Html$Attributes.$class("dialog")
                                                                       ,$Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                                                                             ,_0: "top"
                                                                                                             ,_1: A2($Basics._op["++"],
                                                                                                             $Basics.toString((_v5._1 / 2 | 0) - 167),
                                                                                                             "px")}
                                                                                                            ,{ctor: "_Tuple2"
                                                                                                             ,_0: "left"
                                                                                                             ,_1: A2($Basics._op["++"],
                                                                                                             $Basics.toString((_v5._0 / 2 | 0) - 257),
                                                                                                             "px")}]))]),
                                                          _L.fromArray([A2($Html.h2,
                                                                       _L.fromArray([]),
                                                                       _L.fromArray([$Html.text(m$.query)]))
                                                                       ,A2($Html.div,
                                                                       _L.fromArray([]),
                                                                       _L.fromArray([A2($Html.button,
                                                                                    _L.fromArray([$Html$Attributes.classList(_L.fromArray([{ctor: "_Tuple2"
                                                                                                                                           ,_0: "confirm-button"
                                                                                                                                           ,_1: _U.eq(m$.selectedOption,
                                                                                                                                           0)}
                                                                                                                                          ,{ctor: "_Tuple2"
                                                                                                                                           ,_0: "cancel-button"
                                                                                                                                           ,_1: !_U.eq(m$.selectedOption,
                                                                                                 ...
                                                                                                 address,
                                                                                                 m$.confirm)]),
                                                                                    _L.fromArray([$Html.text("Confirm")]))
                                                                                    ,A2($Html.button,
                                                                                    _L.fromArray([$Html$Attributes.classList(_L.fromArray([{ctor: "_Tuple2"
                                                                                                                                           ,_0: "confirm-button"
                                                                                                                                           ,_1: !_U.eq(m$.selectedOption,
                                     ...
                                     _U.badCase($moduleName,
                                     "between lines 84 and 106");
                                  }();
                               })});
            case "KeyboardShortcutDialog":
            return $Maybe.Just({_: {}
                               ,keyboardInputMap: F2(function (keypresses,
                               dialModel) {
                                  return function () {
                                        ...
                                        switch (keypresses._0)
                                          {case 27:
                                             switch (keypresses._1.ctor)
                                               {case "[]":
                                                  return _U.replace([["action"
                                                                     ,$Planner$Event.Dialog($Planner$UI$Dialog.Hide)]
                                                                    ,["setContext"
                                                                     ,$Maybe.Just($Planner$UI$Context.Default)]],
                                                    $Planner$Event.emptyEvent);}
                                               break;
                               ...
                               dialModel) {
                                  return function () {
                                     ...
                                     {case "_Tuple2":
                                        return function () {
                                             var _raw = dialModel,
                                             $ = _raw.ctor === "KeyboardShortcutDialog" ? _raw : _U.badCase($moduleName,
                                             "on line 132, column 58 to 67"),
                                             m$ = $._0;
                                             return A2($Html.div,
                                             _L.fromArray([]),
                                             _L.fromArray([A2($Html.div,
                                                          ...
                                                          _L.fromArray([]))
                                                          ,A2($Html.div,
                                                          _L.fromArray([$Html$Attributes.$class("dialog keyboard-shortcuts")
                                                                       ,$Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                                                                             ,_0: "top"
                                                                                                             ,_1: A2($Basics._op["++"],
                                                                                                             $Basics.toString($Basics.toFloat(_v15._1) * 0.5 - $Basics.toFloat(_v15._1) * 0.8 / 2),
                                                                                                             "px")}
                                                                                                            ,{ctor: "_Tuple2"
                                                                                                             ,_0: "left"
                                                                                                             ,_1: A2($Basics._op["++"],
                                                                                                             $Basics.toString((_v15._0 / 2 | 0) - 250),
                                                                                                             "px")}
                                                                                                            ,{ctor: "_Tuple2"
                                                                                                             ,_0: "height"
                                                                                                             ,_1: A2($Basics._op["++"],
                                                                                                             $Basics.toString($Basics.toFloat(_v15._1) * 0.8),
                                                                                                             "px")}]))]),
                                                          _L.fromArray([$Html.ul(_L.fromArray([]))(A3($List.foldr,
                                                          F2(function (_v19,
                                                          acc) {
                                                             return function () {
                                                                switch (_v19.ctor)
                                                                {case "_Tuple2":
                                                                   return function () {
                                                                        ...
                                                                        $List.length(acc),
                                                                        2);
                                                                        var tag = _U.eq(_v19._1,
                                                                        "") ? A2($Html.li,
                                                                        _L.fromArray([$Html$Attributes.$class("heading")]),
                                                                        _L.fromArray([A2($Html.h4,
                                                                        _L.fromArray([]),
                                                                        _L.fromArray([$Html.text(_v19._0)]))])) : A2($Html.li,
                                                                        _L.fromArray([$Html$Attributes.$class(A2($Basics._op["++"],
                                                                        "color-",
                                                                        $Basics.toString(color)))]),
                                                                        _L.fromArray([A2($Html.div,
                                                                                     _L.fromArray([$Html$Attributes.$class("left-side")]),
                                                                                     _L.fromArray([$Html.text(_v19._0)]))
                                                                                     ,A2($Html.div,
                                                                                     _L.fromArray([$Html$Attributes.$class("right-side")]),
                                                                                     _L.fromArray([$Html.text(_v19._1)]))]));
                                                                        return A2($List._op["::"],
                                                                        tag,
                                                                        acc);
                                                                     }();}
                                     ...
                                     _U.badCase($moduleName,
                                     "between lines 132 and 151");
                                  }();
                               })});}
         return $Maybe.Nothing;
      }();
   };
   var keyboardShortcutDialogModel = $Planner$UI$Dialog.KeyboardShortcutDialog({_: {}
                                                                               ,keyMap: _L.fromArray([{ctor: "_Tuple2"
                                                                                                      ,_0: "FILE"
                                                                                                      ,_1: ""}
                                                                                                     ,$Planner$Component$Text.newProjectShortcut
                                                                                                     ,$Planner$Component$Text.saveProjectShortcut
                                                                                                     ,$Planner$Component$Text.loadProjectShortcut
                                                                                                     ,{ctor: "_Tuple2"
                                                                                                      ,_0: "NODE OPERATIONS"
                                                                                                      ,_1: ""}
                                                                                                     ,$Planner$Component$Text.newNodeShortcut
                                                                                                     ,$Planner$Component$Text.renameNodeShortcut
                                                                                                     ,$Planner$Component$Text.toggleExpandedShortcut
                                                                                                     ,$Planner$Component$Text.deleteNodeShortcut
                                                                                                     ,{ctor: "_Tuple2"
                                                                                                      ,_0: "NODE MOVEMENT"
                                                                                                      ,_1: ""}
                                                                                                     ,$Planner$Component$Text.moveNodeLeftShortcut
                                                                                                     ,$Planner$Component$Text.moveNodeUpShortcut
                                                                                                     ,$Planner$Component$Text.moveNodeDownShortcut
                                                                                                     ,$Planner$Component$Text.moveNodeRightShortcut
                                                                                                     ,{ctor: "_Tuple2"
                                                                                                      ,_0: "SELECTION MOVEMENT"
                                                                                                      ,_1: ""}
                                                                                                     ,$Planner$Component$Text.moveSelectionUpShortcut
                                                                                                     ,$Planner$Component$Text.moveSelectionDownShortcut
                                                                                                     ,{ctor: "_Tuple2"
                                                                                                      ,_0: "CHANGING FOCUS"
                                                                                                      ,_1: ""}
                                                                                                     ,$Planner$Component$Text.editTitleShortcut
                                                                                                     ,$Planner$Component$Text.toggleFocusShortcut
                                                                                                     ,{ctor: "_Tuple2"
                                                                                                      ,_0: "HELP MENU"
                                                                                                      ,_1: ""}
                                                                                                     ,$Planner$Component$Text.showHelpShortcut])});
   var emptyConfirmDialogModel = $Planner$UI$Dialog.ConfirmDialog({_: {}
                                                                  ,cancel: _U.replace([["action"
                                                                                       ,$Planner$Event.Dialog($Planner$UI$Dialog.Hide)]
                                                                                      ,["setContext"
                                                                                       ,$Maybe.Just($Planner$UI$Context.Default)]],
                                                                  $Planner$Event.emptyEvent)
                                                                  ,confirm: _U.replace([["action"
                                                                                        ,$Planner$Event.NoOp]
                                                                                       ,["setContext"
                                                                                        ,$Maybe.Just($Planner$UI$Context.Default)]],
                                                                  $Planner$Event.emptyEvent)
                                                                  ,query: ""
                                                                  ,selectedOption: 0});
   var confirm = F3(function (query,
   confirm,
   cancel) {
      return function () {
         var _raw = emptyConfirmDialogModel,
         $ = _raw.ctor === "ConfirmDialog" ? _raw : _U.badCase($moduleName,
         "on line 27, column 36 to 59"),
         model = $._0;
         return createDialog($Planner$UI$Dialog.ConfirmDialog(_U.replace([["query"
                                                                          ,query]
                                                                         ,["confirm"
                                                                          ,A2($Maybe.withDefault,
                                                                          model.confirm,
   ...
   _elm.Planner.UI.DialogBuilder.values = {_op: _op
                                          ,emptyConfirmDialogModel: emptyConfirmDialogModel
                                          ,confirm: confirm
                                          ,keyboardShortcutDialogModel: keyboardShortcutDialogModel
                                          ,createDialog: createDialog};
   return _elm.Planner.UI.DialogBuilder.values;
};
Elm.Planner = Elm.Planner || {};
Elm.Planner.Update = Elm.Planner.Update || {};
Elm.Planner.Update.make = function (_elm) {
   "use strict";
   _elm.Planner = _elm.Planner || {};
   _elm.Planner.Update = _elm.Planner.Update || {};
   if (_elm.Planner.Update.values)
   return _elm.Planner.Update.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Planner.Update",
   $Basics = Elm.Basics.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Planner$Component$Event = Elm.Planner.Component.Event.make(_elm),
   ...
   $Result = Elm.Result.make(_elm),
   $Util$List = Elm.Util.List.make(_elm);
   var keyPressesToEvent = F2(function (keypresses,
   state) {
      return function () {
         switch (keypresses.ctor)
         {case "::":
            switch (keypresses._0)
              {case 17:
                 switch (keypresses._1.ctor)
                   {case "::":
                      switch (keypresses._1._0)
                        {case 191:
                           switch (keypresses._1._1.ctor)
                             {case "[]":
                                return $Planner$Component$Event.newProjectEvent;}
                             break;}
                        break;}
                   break;}
              break;}
         return function () {
            var _v5 = state.ui.context;
            switch (_v5.ctor)
            {case "Default":
               return function () {
                    switch (keypresses.ctor)
                    {case "::":
                       switch (keypresses._0)
                         {case 9:
                            switch (keypresses._1.ctor)
                              {case "[]":
                                 return _U.replace([["setContext"
                                                    ,$Maybe.Just($Planner$UI$Context.MainTextArea)]],
                                   $Planner$Event.emptyEvent);}
                              break;
                            case 13:
                            switch (keypresses._1.ctor)
                                 ...
                                 switch (keypresses._1._0)
                                   {case 17:
                                      switch (keypresses._1._1.ctor)
                                        {case "[]":
                                           return _U.replace([["action"
                                                              ,$Planner$Event.NewItem]],
                                             $Planner$Event.emptyEvent);}
                                        break;}
                                   break;
                                 case "[]":
                                 return _U.replace([["action"
                                                    ,$Planner$Event.RenamingItem($Maybe.Nothing)]],
                                   $Planner$Event.emptyEvent);}
                              break;
                            case 17:
                            switch (keypresses._1.ctor)
                                 ...
                                 switch (keypresses._1._0)
                                   {case 37:
                                      switch (keypresses._1._1.ctor)
                                        {case "[]":
                                           return _U.replace([["action"
                                                              ,$Planner$Event.MoveNode($Planner$Data$Tree.Lift)]],
                                             $Planner$Event.emptyEvent);}
                                        break;
                                      case 38:
                                      switch (keypresses._1._1.ctor)
                                        {case "[]":
                                           return _U.replace([["action"
                                                              ,$Planner$Event.MoveNode($Planner$Data$Tree.ShiftUp)]],
                                             $Planner$Event.emptyEvent);}
                                        break;
                                      case 39:
                                      switch (keypresses._1._1.ctor)
                                        {case "[]":
                                           return _U.replace([["action"
                                                              ,$Planner$Event.MoveNode($Planner$Data$Tree.Lower)]],
                                             $Planner$Event.emptyEvent);}
                                        break;
                                      case 40:
                                      switch (keypresses._1._1.ctor)
                                        {case "[]":
                                           return _U.replace([["action"
                                                              ,$Planner$Event.MoveNode($Planner$Data$Tree.ShiftDown)]],
                                             $Planner$Event.emptyEvent);}
                                        break;}
                                   break;}
                              break;
                            ...
                            switch (keypresses._1.ctor)
                              {case "[]":
                                 return _U.replace([["setContext"
                                                    ,$Maybe.Just($Planner$UI$Context.TitleInput)]],
                                   $Planner$Event.emptyEvent);}
                              break;
                            case 32:
                            switch (keypresses._1.ctor)
                              {case "[]":
                                 return _U.replace([["action"
                                                    ,$Planner$Event.ToggleExpanded($Maybe.Nothing)]],
                                   $Planner$Event.emptyEvent);}
                              break;
                            case 38:
                            switch (keypresses._1.ctor)
                              {case "[]":
                                 return _U.replace([["action"
                                                    ,$Planner$Event.MoveSelection($Planner$Event.Up)]],
                                   $Planner$Event.emptyEvent);}
                              break;
                            case 40:
                            switch (keypresses._1.ctor)
                              {case "[]":
                                 return _U.replace([["action"
                                                    ,$Planner$Event.MoveSelection($Planner$Event.Down)]],
                                   $Planner$Event.emptyEvent);}
                              break;
                            case 46:
                            switch (keypresses._1.ctor)
                              {case "[]":
                                 return $Planner$Component$Event.deleteNodeEvent;}
                              break;
                            case 72:
                            switch (keypresses._1.ctor)
                              {case "[]":
                                 return $Planner$Component$Event.showHelpEvent;}
                              break;}
                         break;}
                    return $Planner$Event.emptyEvent;
                 }();
               case "Dialog":
               return $Maybe.withDefault($Planner$Event.emptyEvent)(A2($Maybe.andThen,
                 state.ui.dialog,
                 function (dialog) {
                    return $Maybe.Just(A2(dialog.keyboardInputMap,
                    keypresses,
                    dialog.model));
                 }));
               case "MainTextArea":
                       ...
                       switch (keypresses._0)
                         {case 9:
                            switch (keypresses._1.ctor)
                              {case "[]":
                                 return _U.replace([["setContext"
                                                    ,$Maybe.Just(state.ui.lastContext)]],
                                   $Planner$Event.emptyEvent);}
                              break;
                            case 13:
                            switch (keypresses._1.ctor)
   ...
   s) {
      return function () {
         var oldContext = s.ui.context;
         var ui$ = s.ui;
         var event = function () {
            switch (input.ctor)
            {case "KeyboardEvent":
               return A2(keyPressesToEvent,
                 input._0,
                 s);
               case "UIEvent":
               return input._0;}
         ...
         var newContext = A2($Maybe.withDefault,
         s.ui.context,
         event.setContext);
         var state = _U.replace([["ui"
                                 ,_U.replace([["context"
                                              ,newContext]
                                             ,["lastContext"
                                              ,!_U.eq(newContext,
                                              oldContext) ? oldContext : s.ui.lastContext]
                                             ,["lastSelectedId"
                                              ,s.selectedId]],
                                 ui$)]],
         s);
         var ui = state.ui;
         var dialog = state.ui.dialog;
         var selectableNodes = A2($Planner$Data$Tree.mapN,
         function (_v25) {
            return function () {
               switch (_v25.ctor)
               {case "Node":
                  return $Basics.not(_v25._0.expanded) ? A3($Planner$Data$Tree.Node,
                    _v25._0,
                    _L.fromArray([]),
                    _v25._2) : A3($Planner$Data$Tree.Node,
                    _v25._0,
                    _v25._1,
                    _v25._2);}
               _U.badCase($moduleName,
               "on line 39, column 66 to 145");
            }();
         },
         state.rootNode);
         return function () {
            var _v30 = event.action;
            switch (_v30.ctor)
            {case "DeleteItem":
               return function () {
                    var previousNode = $Maybe.withDefault($Planner$Data$Tree.dummyNode($Planner$Model.newItem))($List.head($List.reverse(A2($Util$List.takeWhile,
                    F2(function (x,y) {
                       return !_U.eq(x,y);
                    })(A3($Planner$Data$Tree.nodeByIdWithDefault,
                    $Planner$Data$Tree.dummyNode($Planner$Model.newItem),
                    state.selectedId,
                    state.rootNode)),
                    $Planner$Data$Tree.flatten(selectableNodes)))));
                    var prevId = _U.cmp($Planner$Data$Tree.id(previousNode),
                    0) < 0 ? 0 : $Planner$Data$Tree.id(previousNode);
                    return _U.replace([["rootNode"
                                       ,A2($Planner$Data$Tree.removeNodeById,
                                       state.selectedId,
                                       state.rootNode)]
                                      ,["selectedId",prevId]
                                      ,["ui"
               ...
               switch (_v30._0.ctor)
                 {case "HideWith":
                    return A2(update,
                      $Planner$Event.UIEvent(_v30._0._0),
                      _U.replace([["ui"
                                  ,_U.replace([["dialog"
                                               ,$Maybe.Nothing]],
                                  ui)]],
               ...
               return function () {
                    ...
                    {case "Lower":
                       return function () {
                            var newState = _U.replace([["rootNode"
                                                       ,A3($Planner$Data$Tree.moveNodeById,
                                                       _v30._0,
                                                       state.selectedId,
                                                       state.rootNode)]],
                            state);
                            var parent = $Maybe.withDefault(state.rootNode)(A2($Planner$Data$Tree.parent,
                            A3($Planner$Data$Tree.nodeByIdWithDefault,
                            state.rootNode,
                            state.selectedId,
                            newState.rootNode),
                            newState.rootNode));
                            return _U.replace([["rootNode"
                                               ,A3($Planner$Data$Tree.mapToNodeById,
                                               function (item) {
                                                  return _U.replace([["expanded"
                                                                     ,true]],
                                                  item);
                                               },
                                               $Planner$Data$Tree.id(parent),
                                               newState.rootNode)]],
                            newState);
                         }();}
                    return _U.replace([["rootNode"
               ...
               return function () {
                    ...
                    {case "Down":
                       return _U.replace([["selectedId"
                                          ,$Planner$Data$Tree.id($Maybe.withDefault(A3($Planner$Data$Tree.Node,
                                          $Planner$Model.newItem,
                                          _L.fromArray([]),
                                          state.selectedId))($List.head($List.drop(1)(A2($Util$List.dropWhile,
                                          function ($) {
                                             return F2(function (x,y) {
                                                return !_U.eq(x,y);
                                             })(state.selectedId)($Planner$Data$Tree.id($));
                                          },
                                          $Planner$Data$Tree.flatten(selectableNodes))))))]],
                         state);
                       case "Up":
                       return _U.replace([["selectedId"
                                          ...
                                          $Planner$Model.newItem,
                                          _L.fromArray([]),
                                          0))($List.head($List.reverse(A2($Util$List.takeWhile,
                                          function ($) {
                                             return F2(function (x,y) {
                                                return !_U.eq(x,y);
                                             })(state.selectedId)($Planner$Data$Tree.id($));
               ...
               case "NewItem":
               return function () {
                    var child = A3($Planner$Data$Tree.newNode,
                    state.rootNode,
                    $Planner$Model.newItem,
                    _L.fromArray([]));
                    var parent = A3($Planner$Data$Tree.nodeByIdWithDefault,
                    $Planner$Data$Tree.dummyNode($Planner$Model.newItem),
                    state.selectedId,
                    state.rootNode);
                    var newTree = $Planner$Data$Tree.valueM(function (item) {
                       return _U.replace([["expanded"
                                          ,true]],
                       item);
                    })(A2($Planner$Data$Tree.moveNode,
                    $Planner$Data$Tree.Lift,
                    child)(A3($Planner$Data$Tree.addChildTo,
                    parent,
                    child,
                    state.rootNode)));
                    return _U.replace([["rootNode"
               ...
               return _U.replace([["rootNode"
                 ...
                 state);
               case "RenameProject":
               return _U.replace([["projectTitle"
                                  ,_v30._0]],
                 state);
               case "RenamingItem":
               return function () {
                    ...
                    {case "Just":
                       return _U.replace([["selectedId"
                                         ...
                                         ,["ui"
                                          ,_U.replace([["context"
                                                       ,$Planner$UI$Context.RenamingNode]],
                                          ui)]],
                         state);
                       case "Nothing":
                       return _U.replace([["ui"
               ...
               return function () {
                    ...
                    {case "Just":
                       return function () {
                            var toggledNode = A3($Planner$Data$Tree.nodeByIdWithDefault,
                            $Planner$Data$Tree.dummyNode($Planner$Model.newItem),
                            _v30._0._0,
                            state.rootNode);
                            return function () {
                               var _v53 = A2($Planner$Data$Tree.nodeById,
                               state.selectedId,
                               toggledNode);
                               switch (_v53.ctor)
                               {case "Just":
                                  return _U.replace([["rootNode"
                                                     ...
                                                     function (item) {
                                                        return _U.replace([["expanded"
                                                                           ,$Basics.not(item.expanded)]],
                                                        item);
                                                     },
                                                     _v30._0._0,
                                                     state.rootNode)]
                                                    ,["selectedId",_v30._0._0]],
                                    state);
                                  case "Nothing":
                                  return _U.replace([["rootNode"
                                                     ,A3($Planner$Data$Tree.mapToNodeById,
   ...
   _elm.Planner.Update.values = {_op: _op
                                ,update: update
                                ,keyPressesToEvent: keyPressesToEvent};
   return _elm.Planner.Update.values;
};
Elm.Planner = Elm.Planner || {};
Elm.Planner.View = Elm.Planner.View || {};
Elm.Planner.View.make = function (_elm) {
   "use strict";
   _elm.Planner = _elm.Planner || {};
   _elm.Planner.View = _elm.Planner.View || {};
   if (_elm.Planner.View.values)
   return _elm.Planner.View.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Planner.View",
   $Basics = Elm.Basics.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   $Html$Events = Elm.Html.Events.make(_elm),
   ...
   $Planner$UI$Context = Elm.Planner.UI.Context.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var treeToHtmlTree = F3(function (address,
   state,
   _v0) {
      return function () {
         switch (_v0.ctor)
         {case "Node":
            return function () {
                 var liContent = _U.eq(state.ui.context,
                 $Planner$UI$Context.RenamingNode) && _U.eq(_v0._2,
                 state.selectedId) ? A2($Html.input,
                 _L.fromArray([$Html$Attributes.type$("text")
                              ...
                              address,
                              _U.replace([["action"
                                          ,$Planner$Event.SelectItem(_v0._2)]
                                         ,["setContext"
                                          ,$Maybe.Just($Planner$UI$Context.RenamingNode)]],
                              $Planner$Event.emptyEvent))
                              ,A3($Html$Events.on,
                              "input",
                              $Html$Events.targetValue,
                              function ($) {
                                 return $Signal.message(address)(function (act) {
                                    return _U.replace([["action"
                                                       ,act]],
                                    $Planner$Event.emptyEvent);
                                 }($Planner$Event.UpdateItemTitle($)));
                              })]),
                 _L.fromArray([])) : A2($Html.div,
                 _L.fromArray([$Html$Attributes.id(A2($Basics._op["++"],
                              ...
                              ,$Html$Attributes.classList(_L.fromArray([{ctor: "_Tuple2"
                                                                       ...
                                                                       ,{ctor: "_Tuple2"
                                                                        ,_0: "selected-focused"
                                                                        ,_1: _U.eq(_v0._2,
                                                                        state.selectedId) && _U.eq(state.ui.context,
                                                                        $Planner$UI$Context.Default)}
                                                                       ,{ctor: "_Tuple2"
                                                                        ,_0: "selected-unfocused"
                                                                        ,_1: _U.eq(_v0._2,
                                                                        state.selectedId) && $Basics.not(_U.eq(state.ui.context,
                                                                        $Planner$UI$Context.Default))}]))
                              ,A2($Html$Events.onClick,
                              address,
                              _U.replace([["action"
                              ...
                              address,
                              _U.replace([["action"
                                          ,$Planner$Event.RenamingItem($Maybe.Just(_v0._2))]],
                              $Planner$Event.emptyEvent))]),
                 _L.fromArray([$Html.text(_v0._0.title)]));
                 return A2($Html.ul,
                 _L.fromArray([$Html$Attributes.classList(_L.fromArray([{ctor: "_Tuple2"
                                                                        ,_0: "root-node"
                                                                        ,_1: _U.eq(_v0._2,
                                                                        0)}]))]),
                 _L.fromArray([$Html.li(_L.fromArray([$Html$Attributes.classList(_L.fromArray([{ctor: "_Tuple2"
                                                                                               ,_0: "hidden"
                                                                                               ,_1: $Basics.not(_v0._0.expanded) && !_U.eq(_v0._1,
                                                                                               _L.fromArray([]))}]))]))(A2($List._op["::"],
                 A2($Html.div,
                 _L.fromArray([$Html$Attributes.$class("arrow-container")]),
                 _L.fromArray([A2($Html.img,
                 _L.fromArray([$Html$Attributes.$class("expand-arrow-icon")
                              ,$Html$Attributes.src(_v0._0.expanded ? "img/arrow-expanded.png" : "img/arrow-collapsed.png")
                              ,A2($Html$Events.onClick,
                              address,
                              _U.replace([["action"
                                          ,$Planner$Event.ToggleExpanded($Maybe.Just(_v0._2))]],
                              $Planner$Event.emptyEvent))]),
                 _L.fromArray([]))])),
                 A2($List._op["::"],
                 liContent,
                 _v0._0.expanded ? A2($List.map,
                 A3($Html$Lazy.lazy3,
                 treeToHtmlTree,
                 address,
                 state),
         ...
         _U.badCase($moduleName,
         "between lines 97 and 129");
      }();
   });
   var render = F3(function (address,
   state,
   _v5) {
      return function () {
         switch (_v5.ctor)
         {case "_Tuple2":
            return function () {
                 var dialog = $Maybe.withDefault(A2($Html.div,
                 _L.fromArray([]),
                 _L.fromArray([])))(A2($Maybe.andThen,
                 state.ui.dialog,
                 function (dialog) {
                    return $Maybe.Just(A3(dialog.view,
                    {ctor: "_Tuple2"
                    ,_0: _v5._0
                    ,_1: _v5._1},
                    address,
                 ...
                 _L.fromArray([dialog
                              ,A2($Html.div,
                              _L.fromArray([$Html$Attributes.$class("title-bar")]),
                              _L.fromArray([A2($Html.input,
                              _L.fromArray([$Html$Attributes.id("title-bar-input")
                                           ,_U.eq(state.ui.context,
                                           $Planner$UI$Context.TitleInput) ? $Html$Attributes.style(_L.fromArray([])) : $Html$Attributes.value(state.projectTitle)
                                           ...
                                           function ($) {
                                              return $Signal.message(address)(function (act) {
                                                 return _U.replace([["action"
                                                                    ,act]],
                                                 $Planner$Event.emptyEvent);
                                              }($Planner$Event.RenameProject($)));
                                           })
                                           ,A2($Html$Events.onFocus,
                                           address,
                                           _U.replace([["setContext"
                                                       ,$Maybe.Just($Planner$UI$Context.TitleInput)]],
                                           $Planner$Event.emptyEvent))
                                           ,$Html$Attributes.placeholder($Planner$Component$Text.untitledProjectPlaceholderTitle)]),
                              _L.fromArray([]))]))
                              ,A2($Html.div,
                              _L.fromArray([$Html$Attributes.$class("options-bar")
                                           ,A2($Html$Events.onClick,
                                           address,
                                           _U.replace([["setContext"
                                                       ,$Maybe.Just($Planner$UI$Context.Default)]],
                              ...
                              _L.fromArray([A2($Html.i,
                                           _L.fromArray([$Html$Attributes.$class("fa fa-file-text-o icon")
                                                        ,A2($Html$Events.onClick,
                                                        address,
                                                        $Planner$Component$Event.newProjectEvent)
                                                        ,$Html$Attributes.alt($Planner$Component$Text.newProjectButtonAlt)
                                                        ,$Html$Attributes.title($Planner$Component$Text.newProjectButtonAlt)]),
                                           _L.fromArray([]))
                                           ,A2($Html.i,
                                           _L.fromArray([$Html$Attributes.$class("fa fa-download icon")
                                                        ,A2($Html$Events.onClick,
                                                        address,
                                                        _U.replace([["action"
                                                                    ,$Planner$Event.SaveProject]],
                                                        $Planner$Event.emptyEvent))
                                                        ,$Html$Attributes.alt($Planner$Component$Text.saveProjectButtonAlt)
                                                        ,$Html$Attributes.title($Planner$Component$Text.saveProjectButtonAlt)]),
                                           _L.fromArray([]))
                                           ,A2($Html.label,
                                           _L.fromArray([$Html$Attributes.$for("loadButton")]),
                                           _L.fromArray([A2($Html.form,
                                           _L.fromArray([$Html$Attributes.id("loadWrapperForm")]),
                                           _L.fromArray([A2($Html.input,
                                                        _L.fromArray([$Html$Attributes.type$("file")
                                                                     ,$Html$Attributes.id("loadButton")]),
                                                        _L.fromArray([$Html.text("Load")]))
                                                        ,A2($Html.i,
                                                        _L.fromArray([$Html$Attributes.$class("fa fa-upload icon")
                                                                     ,$Html$Attributes.alt($Planner$Component$Text.loadProjectButtonAlt)
                                                                     ,$Html$Attributes.title($Planner$Component$Text.loadProjectButtonAlt)]),
                                                        _L.fromArray([]))]))]))
                                           ,A2($Html.div,
                                           _L.fromArray([$Html$Attributes.$class("divider")]),
                                           _L.fromArray([]))
                                           ,A2($Html.i,
                                           _L.fromArray([$Html$Attributes.$class("fa fa-plus-square-o icon")
                                                        ,A2($Html$Events.onClick,
                                                        address,
                                                        _U.replace([["action"
                                                                    ,$Planner$Event.NewItem]
                                                                   ,["setContext"
                                                                    ,$Maybe.Just($Planner$UI$Context.Default)]],
                                                        $Planner$Event.emptyEvent))
                                                        ,$Html$Attributes.alt($Planner$Component$Text.newNodeButtonAlt)
                                                        ,$Html$Attributes.title($Planner$Component$Text.newNodeButtonAlt)]),
                                           _L.fromArray([]))
                                           ,A2($Html.i,
                                           _L.fromArray([$Html$Attributes.$class("fa fa-pencil icon")
                                                        ,A2($Html$Events.onClick,
                                                        address,
                                                        _U.replace([["action"
                                                                    ,$Planner$Event.RenamingItem($Maybe.Nothing)]],
                                                        $Planner$Event.emptyEvent))
                                                        ,$Html$Attributes.alt($Planner$Component$Text.renameNodeButtonAlt)
                                                        ,$Html$Attributes.title($Planner$Component$Text.renameNodeButtonAlt)]),
                                           _L.fromArray([]))
                                           ,A2($Html.i,
                                           _L.fromArray([$Html$Attributes.$class("fa fa-arrows-v icon")
                                                        ,A2($Html$Events.onClick,
                                                        address,
                                                        _U.replace([["action"
                                                                    ,$Planner$Event.ToggleExpanded($Maybe.Nothing)]],
                                                        $Planner$Event.emptyEvent))
                                                        ,$Html$Attributes.alt($Planner$Component$Text.toggleExpandedButtonAlt)
                                                        ,$Html$Attributes.title($Planner$Component$Text.toggleExpandedButtonAlt)]),
                                           _L.fromArray([]))
                                           ,A2($Html.i,
                                           _L.fromArray([$Html$Attributes.$class("fa fa-trash-o icon")
                                                        ,A2($Html$Events.onClick,
                                                        address,
                                                        $Planner$Component$Event.deleteNodeEvent)
                                                        ,$Html$Attributes.alt($Planner$Component$Text.deleteNodeButtonAlt)
                                                        ,$Html$Attributes.title($Planner$Component$Text.deleteNodeButtonAlt)]),
                                           _L.fromArray([]))
                                           ,A2($Html.div,
                                           _L.fromArray([$Html$Attributes.$class("divider")]),
                                           _L.fromArray([]))
                                           ,A2($Html.i,
                                           _L.fromArray([$Html$Attributes.$class("fa fa-arrow-left icon")
                                                        ,A2($Html$Events.onClick,
                                                        address,
                                                        _U.replace([["action"
                                                                    ,$Planner$Event.MoveNode($Planner$Data$Tree.Lift)]
                                                                   ,["setContext"
                                                                    ,$Maybe.Just($Planner$UI$Context.Default)]],
                                                        $Planner$Event.emptyEvent))
                                                        ,$Html$Attributes.alt($Planner$Component$Text.moveNodeLeftButtonAlt)
                                                        ,$Html$Attributes.title($Planner$Component$Text.moveNodeLeftButtonAlt)]),
                                           _L.fromArray([]))
                                           ,A2($Html.i,
                                           _L.fromArray([$Html$Attributes.$class("fa fa-arrow-up icon")
                                                        ,A2($Html$Events.onClick,
                                                        address,
                                                        _U.replace([["action"
                                                                    ,$Planner$Event.MoveNode($Planner$Data$Tree.ShiftUp)]
                                                                   ,["setContext"
                                                                    ,$Maybe.Just($Planner$UI$Context.Default)]],
                                                        $Planner$Event.emptyEvent))
                                                        ,$Html$Attributes.alt($Planner$Component$Text.moveNodeUpButtonAlt)
                                                        ,$Html$Attributes.title($Planner$Component$Text.moveNodeUpButtonAlt)]),
                                           _L.fromArray([]))
                                           ,A2($Html.i,
                                           _L.fromArray([$Html$Attributes.$class("fa fa-arrow-down icon")
                                                        ,A2($Html$Events.onClick,
                                                        address,
                                                        _U.replace([["action"
                                                                    ,$Planner$Event.MoveNode($Planner$Data$Tree.ShiftDown)]
                                                                   ,["setContext"
                                                                    ,$Maybe.Just($Planner$UI$Context.Default)]],
                                                        $Planner$Event.emptyEvent))
                                                        ,$Html$Attributes.alt($Planner$Component$Text.moveNodeDownButtonAlt)
                                                        ,$Html$Attributes.title($Planner$Component$Text.moveNodeDownButtonAlt)]),
                                           _L.fromArray([]))
                                           ,A2($Html.i,
                                           _L.fromArray([$Html$Attributes.$class("fa fa-arrow-right icon")
                                                        ,A2($Html$Events.onClick,
                                                        address,
                                                        _U.replace([["action"
                                                                    ,$Planner$Event.MoveNode($Planner$Data$Tree.Lower)]
                                                                   ,["setContext"
                                                                    ,$Maybe.Just($Planner$UI$Context.Default)]],
                                                        $Planner$Event.emptyEvent))
                                                        ,$Html$Attributes.alt($Planner$Component$Text.moveNodeRightButtonAlt)
                                                        ,$Html$Attributes.title($Planner$Component$Text.moveNodeRightButtonAlt)]),
                                           _L.fromArray([]))
                                           ,A2($Html.div,
                                           _L.fromArray([$Html$Attributes.$class("divider")]),
                                           _L.fromArray([]))
                                           ,A2($Html.i,
                                           _L.fromArray([$Html$Attributes.$class("fa fa-caret-square-o-up icon")
                                                        ,A2($Html$Events.onClick,
                                                        address,
                                                        _U.replace([["action"
                                                                    ,$Planner$Event.SetAllExpanded(false)]
                                                                   ,["setContext"
                                                                    ,$Maybe.Just($Planner$UI$Context.Default)]],
                                                        $Planner$Event.emptyEvent))
                                                        ,$Html$Attributes.alt($Planner$Component$Text.collapseAllButtonAlt)
                                                        ,$Html$Attributes.title($Planner$Component$Text.collapseAllButtonAlt)]),
                                           _L.fromArray([]))
                                           ,A2($Html.i,
                                           _L.fromArray([$Html$Attributes.$class("fa fa-caret-square-o-down icon")
                                                        ,A2($Html$Events.onClick,
                                                        address,
                                                        _U.replace([["action"
                                                                    ,$Planner$Event.SetAllExpanded(true)]
                                                                   ,["setContext"
                                                                    ,$Maybe.Just($Planner$UI$Context.Default)]],
                                                        $Planner$Event.emptyEvent))
                                                        ,$Html$Attributes.alt($Planner$Component$Text.expandAllButtonAlt)
                                                        ,$Html$Attributes.title($Planner$Component$Text.expandAllButtonAlt)]),
                                           _L.fromArray([]))
                                           ,A2($Html.i,
                                           _L.fromArray([$Html$Attributes.$class("fa fa-question-circle icon")
                                                        ,$Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                                                              ,_0: "float"
                                                                                              ,_1: "right"}]))
                                                        ,A2($Html$Events.onClick,
                                                        address,
                                                        $Planner$Component$Event.showHelpEvent)
                                                        ,$Html$Attributes.alt($Planner$Component$Text.showHelpButtonAlt)
                                                        ,$Html$Attributes.title($Planner$Component$Text.showHelpButtonAlt)]),
                                           _L.fromArray([]))]))
                              ,A2($Html.div,
                              _L.fromArray([$Html$Attributes.$class("main-container")
                                           ,$Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                                                 ,_0: "height"
                                                                                 ,_1: A2($Basics._op["++"],
                                                                                 $Basics.toString(_v5._1 - 140),
                                                                                 "px")}]))]),
                              _L.fromArray([A2($Html.div,
                                           _L.fromArray([$Html$Attributes.$class("tree-pane")
                                                        ,A2($Html$Events.onClick,
                                                        address,
                                                        _U.replace([["setContext"
                                                                    ,$Maybe.Just($Planner$UI$Context.Default)]],
                                           ...
                                           state.rootNode)]))
                                           ,A2($Html.label,
                                           _L.fromArray([$Html$Attributes.$for("textbox")]),
                                           _L.fromArray([A2($Html.div,
                                           _L.fromArray([$Html$Attributes.$class("text-area-container")]),
                                           _L.fromArray([A2($Html.textarea,
                                           _L.fromArray([$Html$Attributes.id("textbox")
                                                        ,$Html$Attributes.placeholder($Planner$Component$Text.emptyTextAreaPlaceholder)
                                                        ,A3($Html$Events.on,
                                                        "input",
                                                        $Html$Events.targetValue,
                                                        function ($) {
                              ...
                              ,A2($Html.footer,
                              _L.fromArray([]),
                              _L.fromArray([$Markdown.toHtml($Planner$Component$Text.footerText)]))]));
              }();}
         _U.badCase($moduleName,
         "between lines 25 and 94");
      }();
   });
   _elm.Planner.View.values = {_op: _op
                              ,render: render
                              ,treeToHtmlTree: treeToHtmlTree};
   return _elm.Planner.View.values;
};
